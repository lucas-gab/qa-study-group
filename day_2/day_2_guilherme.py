...
def calculate_final_grade(student_name, first_grade, second_grade, third_grade, fourth_grade):
    ...
    if final_grade >= 8:
        print(f"{student_name} is free to enjoy their summer vacations.")
...
calculate_final_grade(student_1, student_1_first_grade, student_1_second_grade, student_1_third_grade, student_1_fourth_grade)
calculate_final_grade(student_2, student_2_first_grade, student_2_second_grade, student_2_third_grade, student_2_fourth_grade)
calculate_final_grade(student_3, student_3_first_grade, student_3_second_grade, student_3_third_grade, student_3_fourth_grade)